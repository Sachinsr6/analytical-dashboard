    ...
    datasets: [
      {
        ...
        borderColor: 'hsl(var(--chart-xero))',
        backgroundColor: 'hsl(var(--chart-xero) / 0.2)',
        borderWidth: 3,
        fill: true,
        tension: 0.4,
        pointBackgroundColor: 'hsl(var(--chart-xero))',
      ...
      },
      {
        ...
        borderColor: 'hsl(var(--chart-paypal))',
        backgroundColor: 'hsl(var(--chart-paypal) / 0.2)',
        borderWidth: 3,
        fill: true,
        tension: 0.4,
        pointBackgroundColor: 'hsl(var(--chart-paypal))',
        pointBorderColor: 'hsl(var(--background))',
        pointBorderWidth: 2,
        pointRadius: 6,
        pointHoverRadius: 8,
    ...
    datasets: [
      {
        ...
        backgroundColor: ['hsl(var(--chart-xero))', 'hsl(var(--chart-paypal))'],
    ...
    datasets: [
      {
        label: 'Xero Revenue',
        data: sampleData.xeroRevenue,
        backgroundColor: 'hsl(var(--chart-xero))',
        borderColor: 'hsl(var(--chart-xero))',
        borderWidth: 1,
      },
      {
        label: 'PayPal Revenue',
        data: sampleData.paypalRevenue,
        backgroundColor: 'hsl(var(--chart-paypal))',
        borderColor: 'hsl(var(--chart-paypal))',
        borderWidth: 1,
      },
    ],
...
const ExpenseChart = ({ chartType = 'doughnut', onChartTypeChange }) => {
  ...
  const chartColors = [
    'hsl(var(--chart-categories-1))',
    'hsl(var(--chart-categories-2))',
    'hsl(var(--chart-categories-3))',
    'hsl(var(--chart-categories-4))',
    'hsl(var(--chart-categories-5))',
  ];
          ...
          datasets: [
            {
              label: 'Expenses',
              data: sampleData.amounts,
              borderColor: 'hsl(var(--chart-expense))',
              backgroundColor: 'hsl(var(--chart-expense) / 0.2)',
              borderWidth: 3,
              fill: true,
              tension: 0.4,
              pointBackgroundColor: 'hsl(var(--chart-expense))',
              pointBorderColor: 'hsl(var(--background))',
              pointBorderWidth: 2,
              pointRadius: 6,
            },
    ...
    datasets: [
      {
        ...
        backgroundColor: 'hsl(var(--chart-income))',
        borderColor: 'hsl(var(--chart-income))',
        borderWidth: 1,
        borderRadius: 6,
        borderSkipped: false,
      },
      {
        ...
        backgroundColor: 'hsl(var(--chart-expense))',
        borderColor: 'hsl(var(--chart-expense))',
        borderWidth: 1,
        borderRadius: 6,
        borderSkipped: false,
    ...
    datasets: [
      {
        ...
        data: sampleData.income,
        borderColor: 'hsl(var(--chart-income))',
        backgroundColor: 'hsl(var(--chart-income) / 0.2)',
        borderWidth: 3,
        fill: true,
        tension: 0.4,
        pointBackgroundColor: 'hsl(var(--chart-income))',
        pointBorderColor: 'hsl(var(--background))',
        pointBorderWidth: 2,
        pointRadius: 6,
      },
    ...
    datasets: [
      {
        ...
        backgroundColor: ['hsl(var(--chart-income))', 'hsl(var(--chart-expense))'],
        borderColor: 'hsl(var(--background))',
        borderWidth: 3,
      },
    ],
